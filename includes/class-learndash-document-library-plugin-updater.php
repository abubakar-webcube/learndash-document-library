 ...
 * @version 1.0
 */
class LearnDash_Document_Library_Plugin_Updater {
    ...
    public function show_update_notification( $file, $plugin ) {
        ...
        if ( ! empty( $update_cache->response[ $this->name ] ) && version_compare( $this->version, $version_info->new_version, '<' ) ) {
            ...
            echo '<tr class="plugin-update-tr" id="' . esc_attr($this->slug . '-update" data-slug="' . $this->slug . '" data-plugin="' . $this->slug . '/' . $file) . '">';
    ...
    public function show_changelog() {
        ...
        if( ! current_user_can( 'update_plugins' ) ) {
            /* phppcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped */
